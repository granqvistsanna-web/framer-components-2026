...
export default function HoverList(props: Props) {
    const {
        items = DEFAULT_ITEMS,
        style: styleGroup = {},
    ...
    useEffect(() => {
        ...
        async function init() {
            try {
                ...
                if (mounted) {
                    console.warn("HoverList: GSAP failed to load", err)
                }
            }
        }
...
HoverList.displayName = "Hover List"

// ---------------------------------------------------------------------------
// Property Controls
// ---------------------------------------------------------------------------

addPropertyControls(HoverList, {
    items: {
