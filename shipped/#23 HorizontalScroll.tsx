    ...
    useEffect(() => {
        ...
        ;(async () => {
            try {
                ...
                console.error(
                    "HorizontalScroll: failed to load scripts",
                    e
                )
            }
        })()
    ...
    if (isStatic) {
        if (panelCount === 0) {
            return (
                ...
                >
                    Add panels to Horizontal Scroll
                </div>
            )
        }
...
addPropertyControls(HorizontalScroll, {
    children: {
...
HorizontalScroll.displayName = "Horizontal Scroll"
