...
// ─── Component ──────────────────────────────────────────────
function SwipeSlider(props: SwipeSliderProps) {
    const {
        images = [],
        imageFit = "cover",
        card,
    ...
    useEffect(() => {
        ...
        ;(async () => {
            try {
                ...
                console.error("SwipeSlider: failed to load scripts", e)
            }
        })()
        return () => {
            cancelled = true
...
SwipeSlider.displayName = "Swipe Slider"

// ─── Property Controls ──────────────────────────────────────

addPropertyControls(SwipeSlider, {
    // ─── Content ────────────────────────────────────────────
    images: {
    ...
    autoPlayInterval: {
        ...
        displayStepper: true,
        defaultValue: 3,
        hidden: (props: SwipeSliderProps) => !props.autoPlay,
    },
})
