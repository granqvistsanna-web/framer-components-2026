...
function CoverFlowSlider({
    ...
    useEffect(() => {
        ...
        root.setAttribute("aria-label", "CoverFlow Slider")
...
addPropertyControls(CoverFlowSlider, {
    // --- Content ---
    children: {
    ...
    buttonContent: {
        ...
        defaultValue: "arrows",
        hidden: (props: CoverFlowSliderProps) => !props.showControls,
    },
    prevLabel: {
        type: ControlType.String,
        title: "Prev Label",
        defaultValue: "Prev",
        hidden: (props: CoverFlowSliderProps) => !props.showControls || props.buttonContent !== "text",
    },
    nextLabel: {
        type: ControlType.String,
        title: "Next Label",
    ...
    prevIcon: {
        ...
        title: "Prev Icon",
        hidden: (props: CoverFlowSliderProps) => !props.showControls || props.buttonContent !== "custom",
    },
    nextIcon: {
        type: componentInstanceControlType as any,
        title: "Next Icon",
    ...
    dotSize: {
        ...
        displayStepper: true,
        defaultValue: 8,
        hidden: (props: CoverFlowSliderProps) => !props.showDots,
    },
    dotGap: {
        type: ControlType.Number,
        title: "Dot Gap",
...
CoverFlowSlider.displayName = "CoverFlow Slider"
